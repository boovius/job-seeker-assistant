...
Senior product manager and technical product leader with 12+ years of experience turning ambiguous operational and customer problems into shipped software. Strong track record leading cross-functional teams across product, engineering, design, QA, operations, and stakeholders to shape strategy, define roadmaps, improve workflows, and deliver reliable mobile and web products. Particularly effective in real-world domains where incentives, policy constraints, service operations, and software delivery have to work together.

## Core Strengths

Product strategy and execution · Cross-functional delivery leadership · Workflow and operations design · Roadmap shaping · Requirements and acceptance criteria · Data-informed prioritization · Stakeholder alignment · Technical fluency with engineering teams · Climate and public-impact software
...
- Designed and iterated on product flows, communication features, and implementation plans in a startup environment where ambiguity tolerance and close cross-functional coordination were essential.
