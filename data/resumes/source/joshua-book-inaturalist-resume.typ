...
#set text(font: "Libertinus Sans", size: 10.5pt)
...
#linebreak()
#text(weight: "bold")[Leadership & Delivery:] roadmap execution, cross-functional collaboration, hiring, mentorship, code review, planning, prioritization
