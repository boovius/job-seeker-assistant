...
**Languages & Frameworks:** TypeScript, JavaScript, Ruby, Ruby on Rails, Python, Node.js, React, React Native, Swift, Kotlin, AngularJS  
**Systems & Platform:** REST APIs, GraphQL, PostgreSQL, CI/CD, Docker, Kubernetes, Terraform  
**Delivery & Leadership:** cross-functional collaboration, roadmap shaping, architecture discussions, hiring, mentorship, code review, prioritization
