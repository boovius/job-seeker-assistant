...
#text(weight: "bold")[Product & Delivery:] product discovery, roadmap development, prioritization, PRDs, customer research, analytics, stakeholder communication, cross-functional execution
#linebreak()
#text(weight: "bold")[Technical Fluency:] TypeScript, JavaScript, Python, Node.js, React, React Native, REST APIs, GraphQL, PostgreSQL
#linebreak()
#text(weight: "bold")[Systems & Operations:] workflow design, ETL pipelines, CI/CD, Docker, Terraform, Kubernetes
