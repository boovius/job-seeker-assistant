...
def _parse_salary(value: Any) -> tuple[int | None, int | None, str | None]:
    if isinstance(value, dict):
        ...
        return _to_int(minimum), _to_int(maximum), currency if isinstance(currency, str) else None
...
def apply_user_profiles(db: Session, user_id: str, config_json: dict[str, Any]) -> None:
    ...
    salary_min, salary_max, salary_currency = _parse_salary(core_preferences.get("salary"))
